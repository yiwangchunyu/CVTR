...
if __name__=="__main__":
    ...
    parser.add_argument('--basenum_train', type=int, default=5000, help='')
    parser.add_argument('--basenum_valid', type=int, default=100, help='')
    parser.add_argument('--num_test', type=int, default=100, help='')
